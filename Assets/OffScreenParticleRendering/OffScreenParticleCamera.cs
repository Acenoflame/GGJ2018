...
public class OffScreenParticleCamera : MonoBehaviour
{
   ...
   void OnRenderImage(RenderTexture src, RenderTexture dest)
   {
      ...
      UnityEngine.Profiling.Profiler.BeginSample("Off-Screen Particles");
      // setup materials
      if (compositeMaterial == null)
      {
      ...
      UnityEngine.Profiling.Profiler.BeginSample("Downsample Depth Fast");
      ...
      UnityEngine.Profiling.Profiler.BeginSample("Render Particles");
